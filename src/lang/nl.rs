...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het OABRemoteDesk netwerk..."),
        ...
        ("install_tip", "Je gebruikt een niet geinstalleerde versie. Als gevolg van UAC-beperkingen is het in sommige gevallen niet mogelijk om als controleterminal de muis en het toetsenbord te bedienen of het scherm over te nemen. Klik op de knop hieronder om OABRemoteDesk op het systeem te installeren om het bovenstaande probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Click to download", "Klik om te downloaden"),
        ("Click to update", "Klik om bij te werken"),
        ("Configure", "Configureren"),
        ("config_acc", "Om je bureaublad op afstand te kunnen bedienen, moet je OABRemoteDesk \"toegankelijkheid\" toestemming geven."),
        ("config_screen", "Om toegang te krijgen tot het externe bureaublad, moet je OABRemoteDesk de toestemming \"schermregistratie\" geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u OABRemoteDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geinstalleerde Services], schakel de service [OABRemoteDesk Input] in."),
        ...
        ("Help", "https://OABRemoteDesk.com/docs/en/manual/linux/#x11-required"),
        ("Failed", "Mislukt"),
        ("Succeeded", "Geslaagd"),
        ...
        ("Language", "Taal"),
        ("Keep OABRemoteDesk background service", "OABRemoteDesk achtergronddienst behouden"),
        ...
        ("Show OABRemoteDesk", "Toon OABRemoteDesk"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ...
        ("config_input", "Om het externe bureaublad vanaf het toetsenbord te kunnen bedienen, moet u OABRemoteDesk de rechten \"Invoerbewaking\" geven."),
        ("config_microphone", "Om op afstand te kunnen chatten, moet u OABRemoteDesk 'Audio opnemen' rechten geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende OABRemoteDesk."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Bevestiging wachtwoord OABRemoteDesk"),
