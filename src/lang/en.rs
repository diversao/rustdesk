...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("enter_rustdesk_passwd_tip", "Enter OABRemoteDesk password"),
        ("remember_rustdesk_passwd_tip", "Remember OABRemoteDesk password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify OABRemoteDesk password"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade OABRemoteDesk Server Pro to version {} or newer!"),
