...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the OABRemoteDesk network..."),
        ...
        ("install_tip", "Due to UAC, OABRemoteDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install OABRemoteDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant OABRemoteDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant OABRemoteDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow OABRemoteDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [OABRemoteDesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next OABRemoteDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant OABRemoteDesk \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running OABRemoteDesk."),
        ("config_microphone", "In order to speak remotely, you need to grant OABRemoteDesk \"Record Audio\" permissions."),
        ...
        ("install_cert_tip", "Install OABRemoteDesk certificate"),
        ("confirm_install_cert_tip", "This is a OABRemoteDesk testing certificate, which can be trusted. The certificate will be used to trust and install OABRemoteDesk drivers when required."),
        ...
        ("enter_OABRemoteDesk_passwd_tip", "Enter OABRemoteDesk password"),
        ("remember_OABRemoteDesk_passwd_tip", "Remember OABRemoteDesk password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_OABRemoteDesk_password_tip", "Verify OABRemoteDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use OABRemoteDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Please upgrade OABRemoteDesk Server Pro to version {} or newer!"),
