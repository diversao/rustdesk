...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na OABRemoteDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC OABRemoteDesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate OABRemoteDesk na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, OABRemoteDesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, OABRemoteDesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite OABRemoteDesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [OABRemoteDesk Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep OABRemoteDesk background service", "Zadrži OABRemoteDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje OABRemoteDesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on Boot", ""),
        ...
        ("Show OABRemoteDesk", "Prikazi OABRemoteDesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
