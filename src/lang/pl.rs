...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "OABRemoteDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować OABRemoteDesk w swoim systemie."),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić OABRemoteDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [OABRemoteDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep OABRemoteDesk background service", "Zachowaj usługę OABRemoteDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji OABRemoteDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show OABRemoteDesk", "Pokaż OABRemoteDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji OABRemoteDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu OABRemoteDesk"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy OABRemoteDesk, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników OABRemoteDesk w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z OABRemoteDesk w Twojej sieci."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Weryfikuj hasło OABRemoteDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu OABRemoteDesk i uruchomienia usługi - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Proszę zaktualizować OABRemoteDesk Server Pro do wersji {} lub nowszej!"),
