...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do OAB Remote Desk..."),
        ...
        ("install_tip", "Devido ao UAC, o OAB Remote Desk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o OAB Remote Desk no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao OAB Remote Desk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao OAB Remote Desk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o OAB Remote Desk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [OAB Remote Desk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep OAB Remote Desk background service", "Manter o serviço do OAB Remote Desk executando em segundo plano"),
        ...
        ("Show OAB Remote Desk", "Exibir OAB Remote Desk"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do OAB Remote Desk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do OAB Remote Desk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do OAB Remote Desk."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do OAB Remote Desk"),
