...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети OABRemoteDesk..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC OABRemoteDesk может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки OABRemoteDesk в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить OABRemoteDesk права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить OABRemoteDesk права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить OABRemoteDesk использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"OABRemoteDesk Input\"."),
        ...
        ("Quit", "Выйти"),
        ("doc_mac_permission", "https://OABRemoteDesk.com/docs/ru/manual/mac/#включение-разрешений"),
        ("Help", "Помощь"),
        ("Failed", "Не выполнено"),
        ("Succeeded", "Выполнено"),
        ...
        ("Language", "Язык"),
        ("Keep OABRemoteDesk background service", "Держать в фоне службу OABRemoteDesk"),
        ...
        ("Show OABRemoteDesk", "Показать OABRemoteDesk"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить OABRemoteDesk разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить OABRemoteDesk разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске OABRemoteDesk."),
        ...
        ("install_cert_tip", "Установить сертификат OABRemoteDesk"),
        ("confirm_install_cert_tip", "Это тестовый сертификат OABRemoteDesk, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов OABRemoteDesk."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Подтвердить пароль OABRemoteDesk"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать OABRemoteDesk и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Обновите OABRemoteDesk Server Pro до версии {} или новее!"),
