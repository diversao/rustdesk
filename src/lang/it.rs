...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete OABRemoteDesk..."),
        ...
        ("install_tip", "A causa del controllo account uUtente (UAC), OABRemoteDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare OABRemoteDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a OABRemoteDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a OABRemoteDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a OABRemoteDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [OABRemoteDesk Input]."),
        ...
        ("Language", "Lingua"),
        ("Keep OABRemoteDesk background service", "Mantieni il servizio di OABRemoteDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione OABRemoteDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show OABRemoteDesk", "Visualizza OABRemoteDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a OABRemoteDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione a OABRemoteDesk 'Registra audio'."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto faccia clic su OK nella finestra UAC dell'esecuzione di OABRemoteDesk."),
        ...
        ("install_cert_tip", "Installa certificato OABRemoteDesk"),
        ("confirm_install_cert_tip", "Questo è un certificato di test OABRemoteDesk, che può essere considerato attendibile.\nIl certificato verrà usato per certificarsi ed installare i driver OABRemoteDesk quando richiesto."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Conferma password OABRemoteDesk"),
        ...
        ("Exit", "Esci da OABRemoteDesk"),
        ("Open", "Apri OABRemoteDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare OABRemoteDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Aggiorna OABRemoteDesk Server Pro alla versione {} o successiva!"),
