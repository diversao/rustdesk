...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar OABRemoteDesk tīklu..."),
        ...
        ("install_tip", "UAC dēļ OABRemoteDesk dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu OABRemoteDesk sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Click to download", "Lejupielādēt"),
        ("Click to update", "Atjaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir OABRemoteDesk \"Accessibility\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir OABRemoteDesk \"Screen Recording\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj OABRemoteDesk izmantot servisu \"Accessibility\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un ievadiet [Installed Services], ieslēdziet servisu [OABRemoteDesk Input]."),
        ...
        ("doc_fix_wayland", "https://OABRemoteDesk.com/docs/en/manual/linux/#x11-required"),
        ("Help", "Palīdzība"),
        ("Failed", "Neizdevās"),
        ("Succeeded", "Izdevās"),
        ...
        ("Language", "Valoda"),
        ("Keep OABRemoteDesk background service", "Saglabāt OABRemoteDesk fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo OABRemoteDesk lietojumprogrammas iestatījumu lapu, atrodiet un ievadiet [Battery], noņemiet atzīmi no [Unrestricted]"),
        ...
        ("Show OABRemoteDesk", "Rādīt OABRemoteDesk"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir OABRemoteDesk \"Input Monitoring\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir OABRemoteDesk \"Record Audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas OABRemoteDesk."),
        ...
        ("install_cert_tip", "Instalēt OABRemoteDesk sertifikātu"),
        ("confirm_install_cert_tip", "Šis ir OABRemoteDesk testēšanas sertifikāts, kuram var uzticēties. Sertifikāts tiks izmantots, lai uzticētos un vajadzības gadījumā instalētu OABRemoteDesk draiverus."),
        ...
        ("enter_OABRemoteDesk_passwd_tip", "Ievadiet OABRemoteDesk paroli"),
        ("View Mode", "Skatīšanas režīms"),
        ("login_linux_tip", "Jums ir jāpiesakās attālajā Linux kontā, lai iespējotu X darbvirsmas sesiju"),
        ("verify_OABRemoteDesk_password_tip", "Pārbaudīt OABRemoteDesk paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot OABRemoteDesk, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Lūdzu, jauniniet OABRemoteDesk Server Pro uz versiju {} vai jaunāku!"),
