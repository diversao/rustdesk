...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem OABRemoteDesk-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann OABRemoteDesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren OABRemoteDesk auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie OABRemoteDesk Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie OABRemoteDesk die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie OABRemoteDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"OABRemoteDesk Input\" ein."),
        ...
        ("Quit", "Beenden"),
        ("doc_mac_permission", "https://OABRemoteDesk.com/docs/de/manual/mac/#berechtigungen-aktivieren"),
        ("Help", "Hilfe"),
        ...
        ("Language", "Sprache"),
        ("Keep OABRemoteDesk background service", "OABRemoteDesk im Hintergrund ausführen"),
        ...
        ("Show OABRemoteDesk", "OABRemoteDesk anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie OABRemoteDesk die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie OABRemoteDesk die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von OABRemoteDesk auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "OABRemoteDesk-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein OABRemoteDesk-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um OABRemoteDesk-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_OABRemoteDesk_password_tip", "OABRemoteDesk-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, OABRemoteDesk zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie OABRemoteDesk Server Pro auf die Version {} oder neuer!"),
