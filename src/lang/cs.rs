...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k OABRemoteDesk síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), OABRemoteDesk v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak OABRemoteDesk do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci OABRemoteDesk udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci OABRemoteDesk udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby OABRemoteDesk mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [OABRemoteDesk vstup]."),
        ...
        ("Language", "Jazyk"),
        ("Keep OABRemoteDesk background service", "Zachovat službu OABRemoteDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace OABRemoteDesk, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show OABRemoteDesk", "Zobrazit OABRemoteDesk"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění OABRemoteDesk \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění OABRemoteDesk \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného OABRemoteDesku."),
        ...
        ("install_cert_tip", "Instalace certifikátu OABRemoteDesk"),
        ("confirm_install_cert_tip", "Jedná se o testovací certifikát OABRemoteDesk, kterému lze důvěřovat. Certifikát bude v případě potřeby použit k důvěryhodnosti a instalaci ovladačů OABRemoteDesk."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Ověření hesla OABRemoteDesk"),
