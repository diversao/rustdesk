...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan OABRemoteDesk..."),
        ...
        ("install_tip", "Karena UAC, OABRemoteDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal OABRemoteDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" OABRemoteDesk."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" OABRemoteDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan OABRemoteDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input OABRemoteDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep OABRemoteDesk background service", "Pertahankan OABRemoteDesk berjalan pada service background"),
        ...
        ("Show OABRemoteDesk", "Tampilkan OABRemoteDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada OABRemoteDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada OABRemoteDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC OABRemoteDesk yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat OABRemoteDesk"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian OABRemoteDesk, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver OABRemoteDesk saat diperlukan"),
        ...
        ("verify_OABRemoteDesk_password_tip", "Verifikasi Kata Sandi OABRemoteDesk"),
        ...
        ("scam_text1", "Jika Anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan OABRemoteDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "Silahkan perbarui OABRemoteDesk Server Pro ke versi {} atau yang lebih baru!"),
