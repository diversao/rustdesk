...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі OABRemoteDesk..."),
        ...
        ("install_tip", "Через UAC в деяких випадках OABRemoteDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення OABRemoteDesk в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати OABRemoteDesk дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати OABRemoteDesk дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити OABRemoteDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [OABRemoteDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep OABRemoteDesk background service", "Зберегти фонову службу OABRemoteDesk"),
        ...
        ("Show OABRemoteDesk", "Показати OABRemoteDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати OABRemoteDesk дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати OABRemoteDesk дозвіл на \"Запис аудіо\""),
        ...
        ("install_cert_tip", "Додати сертифікат OABRemoteDesk"),
        ("confirm_install_cert_tip", "Це сертифікат тестування OABRemoteDesk, якому можна довіряти. За потреби сертифікат буде використано для погодження та встановлення драйверів OABRemoteDesk."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Перевірте пароль OABRemoteDesk"),
