...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till OABRemoteDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte OABRemoteDesk fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera OABRemoteDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge OABRemoteDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge OABRemoteDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [OABRemoteDesk Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep OABRemoteDesk background service", "Behåll OABRemoteDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa OABRemoteDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
        ...
        ("Show OABRemoteDesk", "Visa OABRemoteDesk"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
