...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "OABRemoteDeskがUACの影響によりリモート側で正常に動作しない場合があります。UACを回避するには、下のボタンをクリックしてシステムにOABRemoteDeskをインストールしてください。"),
        ("Click to upgrade", "アップグレード"),
        ("Click to download", "ダウンロード"),
        ("Click to update", "アップデート"),
        ("Configure", "設定"),
        ("config_acc", "リモートからあなたのデスクトップを操作するには、OABRemoteDeskに「アクセシビリティ」権限を与える必要があります。"),
        ("config_screen", "リモートからあなたのデスクトップにアクセスするには、OABRemoteDeskに「画面収録」権限を与える必要があります。"),
        ("Installing ...", "インストール中..."),
        ("Install", "インストール"),
        ("Installation", "インストール"),
        ...
        ("android_input_permission_tip1", "このAndroid端末をリモートの端末からマウスやタッチで操作するには、OABRemoteDeskに「アクセシビリティ」サービスの使用を許可する必要があります。"),
        ...
        ("Quit", "終了"),
        ("doc_mac_permission", "https://OABRemoteDesk.com/docs/en/manual/mac/#enable-permissions"), // @TODO: Update url when someone translates the docum"),
        ("Help", "ヘルプ"),
        ("Failed", "失敗"),
        ("Succeeded", "成功"),
        ...
        ("Language", "言語"),
        ("Keep OABRemoteDesk background service", "OABRemoteDesk バックグラウンドサービスを維持"),
