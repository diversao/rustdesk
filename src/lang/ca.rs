...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connexió a la xarxa OABRemoteDesk en progrés..."),
        ...
        ("android_input_permission_tip1", "Per a que un dispositiu remot controli el seu dispositiu Android amb el ratolí o tocs, cal permetre que OABRemoteDesk utilitzi el servei d' \"Accesibilitat\"."),
        ("android_input_permission_tip2", "Vagi a la pàgina de [Serveis instal·lats], activi el servici [OABRemoteDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep OABRemoteDesk background service", "Mantenir OABRemoteDesk com a servei en segon pla"),
