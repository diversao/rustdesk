...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua OABRemoteDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca OABRemoteDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala OABRemoteDesk."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți OABRemoteDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți OABRemoteDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți OABRemoteDesk să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [OABRemoteDesk Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep OABRemoteDesk background service", "Rulează serviciul OABRemoteDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației OABRemoteDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show OABRemoteDesk", "Afișează OABRemoteDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi OABRemoteDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi OABRemoteDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din OABRemoteDesk care rulează."),
        ...
        ("install_cert_tip", "Instalează certificatul OABRemoteDesk"),
        ("confirm_install_cert_tip", "Acesta este un certificat de testare OABRemoteDesk și este de încredere. Certificatul va fi utilizat pentru a acorda încredere și instala drivere OABRemoteDesk atunci când este necesar."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Verifică parola OABRemoteDesk"),
