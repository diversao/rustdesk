...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red OABRemoteDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que OABRemoteDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar OABRemoteDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a OABRemoteDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a OABRemoteDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que OABRemoteDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [OABRemoteDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep OABRemoteDesk background service", "Dejar OABRemoteDesk como Servicio en 2do plano"),
        ...
        ("Show OABRemoteDesk", "Mostrar OABRemoteDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a OABRemoteDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a OABRemoteDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Verificar la contraseña de OABRemoteDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses OABRemoteDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_OABRemoteDesk_server_pro_to_{}_tip", "¡Por favor, actualiza OABRemoteDesk Server Pro a la versión {} o superior"),
