...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie OABRemoteDesk tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti OABRemoteDesk netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte OABRemoteDesk į savo kompiuterį."),
        ...
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti OABRemoteDesk \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti OABRemoteDesk leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad OABRemoteDesk startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti OABRemoteDesk naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"OABRemoteDesk įvestis\" paslaugą."),
        ...
        ("Quit", "Išeiti"),
        ("doc_mac_permission", "https://OABRemoteDesk.com/docs/en/manual/mac/"),
        ("Help", "Pagalba"),
        ("Failed", "Nepavyko"),
        ("Succeeded", "Pavyko"),
        ...
        ("Language", "Kalba"),
        ("Keep OABRemoteDesk background service", "Palikti OABRemoteDesk fonine paslauga"),
        ...
        ("Show OABRemoteDesk", "Rodyti OABRemoteDesk"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti OABRemoteDesk leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti OABRemoteDesk leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant OABRemoteDesk UAC lange paspaustų \"OK\"."),
        ...
        ("verify_OABRemoteDesk_password_tip", "Įveskite kliento OABRemoteDesk slaptažodį"),
