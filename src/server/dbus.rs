...
///
/// Note:
/// On linux, we use dbus to communicate multiple OABRemoteDesk process.
...
const DBUS_NAME: &str = "org.OABRemoteDesk.OABRemoteDesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "OABRemoteDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.OABRemoteDesk.OABRemoteDesk /dbus org.OABRemoteDesk.OABRemoteDesk.NewConnection string:'PEER_ID'`
