...
fn get_modifier_state(key: Key, en: &mut Enigo) -> bool {
    // https://github.com/OABRemoteDesk/OABRemoteDesk/issues/332
...
pub async fn lock_screen() {
    ...
    if #[cfg(target_os = "linux")] {
        ...
        // loginctl lock-session also not work, they both work run OABRemoteDesk from cmd
        std::thread::spawn(|| {
...
// https://github.com/OABRemoteDesk/OABRemoteDesk/issues/3928#issuecomment-1496936687
// https://github.com/OABRemoteDesk/OABRemoteDesk/issues/3928#issuecomment-1500415822
// https://github.com/OABRemoteDesk/OABRemoteDesk/issues/3928#issuecomment-1500773473
#[cfg(any(target_os = "windows", target_os = "linux"))]
