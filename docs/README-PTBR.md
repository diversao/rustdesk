<p align="center">
  <img src="../res/logo-header.svg" alt="OABRemoteDesk - Seu desktop remoto"><br>
  ...
  <b>Precisamos de sua ajuda para traduzir este README e a <a href="https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/lang">UI do OABRemoteDesk</a> para sua língua nativa</b>
</p>

Converse conosco: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Mais um software de desktop remoto, escrito em Rust. Funciona por padrão, sem necessidade de configuração. Você tem completo controle de seus dados, sem se preocupar com segurança. Você pode usar nossos servidores de rendezvous/relay, [configurar seu próprio](https://OABRemoteDesk.com/server), ou [escrever seu próprio servidor de rendezvous/relay](https://github.com/OABRemoteDesk/OABRemoteDesk-server-demo).

OABRemoteDesk acolhe contribuições de todos. Leia [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) para ver como começar.

[**DOWNLOAD DE BINÁRIOS**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
OABRemoteDesk não suporta Wayland. Veja [esse link](https://docs.fedoraproject.org/pt_BR/quick-docs/configuring-xorg-as-default-gnome-session/) para configurar o Xorg como a sessão padrão do GNOME.
...
Por favor verifique que está executando estes comandos da raiz do repositório do OABRemoteDesk, senão a aplicação pode não encontrar os recursos necessários. Note também que outros subcomandos do cargo como `install` ou `run` não são suportados atualmente via este método, já que eles iriam instalar ou rodar o programa dentro do container ao invés do host.

## Estrutura de arquivos

- **[libs/hbb_common](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/hbb_common)**: codec de vídeo, configurações, wrapper de tcp/udp, protobuf, funções de sistema de arquivos para transferência de arquivos, e outras funções utilitárias
- **[libs/scrap](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/scrap)**: captura de tela
- **[libs/enigo](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/enigo)**: controle de teclado/mouse específico a cada plataforma
- **[src/ui](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/server)**: serviços de áudio/área de transferência/entrada/vídeo, e conexões de rede
- **[src/client.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/client.rs)**: iniciar uma conexão "peer to peer"
- **[src/rendezvous_mediator.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/rendezvous_mediator.rs)**: Comunicação com [OABRemoteDesk-server](https://github.com/OABRemoteDesk/OABRemoteDesk-server), aguardar pela conexão remota direta (TCP hole punching) ou conexão indireta (relayed)
- **[src/platform](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/platform)**: código específico a cada plataforma
