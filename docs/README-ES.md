...
Chatea con nosotros: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Otro software de escritorio remoto, escrito en Rust. Funciona de forma inmediata, sin necesidad de configuración. Tienes el control total de tus datos, sin preocupaciones sobre la seguridad. Puedes utilizar nuestro servidor de rendezvous/relay, [instalar el tuyo](https://OABRemoteDesk.com/server), o [escribir tu propio servidor rendezvous/relay](https://github.com/OABRemoteDesk/OABRemoteDesk-server-demo).

OABRemoteDesk agradece la contribución de todo el mundo. Lee [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) para ayuda para empezar.

[**¿Cómo funciona OABRemoteDesk?**](https://github.com/OABRemoteDesk/OABRemoteDesk/wiki/How-does-OABRemoteDesk-work%3F)

[**DESCARGA DE BINARIOS**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
OABRemoteDesk no soporta Wayland. Lee [esto](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/) para configurar Xorg en la sesión por defecto de GNOME.

## Soporte para Wayland

Wayland no parece proporcionar ninguna API para enviar pulsaciones de teclas a otras ventanas. Por lo tanto, OABRemoteDesk usa una API de nivel bajo, a saber, el dispositivo `/dev/uinput` (a nivel del kernel de Linux).
...
$ OABRemoteDesk
```
**Aviso**: La grabación de pantalla de Wayland utiliza diferentes interfaces. OABRemoteDesk actualmente sólo soporta org.freedesktop.portal.ScreenCast
```bash
...
Por favor, asegurate de que estás ejecutando estos comandos desde la raíz del repositorio de OABRemoteDesk, de lo contrario la aplicación puede ser incapaz de encontrar los recursos necesarios. También ten en cuenta que otros subcomandos de cargo como `install` o `run` no estan actualmente soportados usando este metodo, ya que instalarían o ejecutarían el programa dentro del contenedor en lugar del host.

## Estructura de archivos

- **[libs/hbb_common](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/hbb_common)**:  codec de video, configuración, tcp/udp wrapper, protobuf, funciones para transferencia de archivos, y otras funciones de utilidad.
- **[libs/scrap](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/scrap)**: captura de pantalla
- **[libs/enigo](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/enigo)**: control del teclado/mouse especificos de cada plataforma
- **[src/ui](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/server)**: sonido/portapapeles/input/servicios de video, y conexiones de red
- **[src/client.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/client.rs)**: iniciar una conexión "peer to peer"
- **[src/rendezvous_mediator.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/rendezvous_mediator.rs)**: Comunicación con [OABRemoteDesk-server](https://github.com/OABRemoteDesk/OABRemoteDesk-server), esperar la conexión remota directa ("TCP hole punching") o conexión indirecta ("relayed")
- **[src/platform](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/platform)**: código específico de cada plataforma
- **[flutter](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/flutter)**: Flutter, código para moviles
- **[flutter/web/js](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/flutter/web/js)**: Javascript para el cliente web Flutter
