<p align="center">
  <img src="../res/logo-header.svg" alt="OABRemoteDesk – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překláním textů tohoto ČTIMNE, <a href="https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/lang">uživatelského rozhraní aplikace OABRemoteDesk</a> a <a href="https://github.com/OABRemoteDesk/doc.OABRemoteDesk.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>

Dopisujte si s námi: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk)


[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Zase další software pro přístup k ploše na dálku, naprogramovaný v jazyce Rust. Funguje hned tak, jak je – není třeba žádného nastavování. Svá data máte ve svých rukách, bez obav o zabezpečení. Je možné používat námi poskytovaný propojovací/předávací (relay) server, [vytvořit si svůj vlastní](https://OABRemoteDesk.com/server), nebo [si dokonce svůj vlastní naprogramovat](https://github.com/OABRemoteDesk/OABRemoteDesk-server-demo), budete-li chtít.

Projekt OABRemoteDesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak OABRemoteDesk funguje?**](https://github.com/OABRemoteDesk/OABRemoteDesk/wiki/How-does-OABRemoteDesk-work%3F)

[**STAHOVÁNÍ ZKOMPILOVANÝCH APLIKACÍ**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
## [Sestavení ze zdrojových kódů](https://OABRemoteDesk.com/docs/en/dev/build/)
...
OABRemoteDesk (zatím) nepodporuje zobrazovací server Wayland. Jak nastavit Xorg jako výchozí pro relace v prostředí GNOME naleznete [zde](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/).
...
Zajistětě, abyste tyto příkazy spouštěli z kořene repozitáře s OABRemoteDesk, jinak aplikace nemusí být schopná nalézt potřebné prostředky (resources). Také si všimněte, že ostatní dílčí príkazy nástroje cargo, jako třeba `install` nebo `run` zatím nejsou prostřednictvím této metody podporovány, protože by vedly k instalaci či spuštění program uvnitř kontejneru namísto přímo v systému.

## Struktura souborů

- **[libs/hbb_common](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/hbb_common)**: kodek videa, nastavení, obalovaní tcp/udp, vyrovnávací paměť protokolu, funkce souborového systému pro přenos souborů a pár dalších podpůrných funkcí
- **[libs/scrap](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/scrap)**: zachytávání obsahu obrazovky
- **[libs/enigo](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/enigo)**: ovládání klávesnice/myši pro jednotlivé platformy
- **[src/ui](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/ui)**: grafické uživatelské rozhraní
- **[src/server](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/server)**: služby pro zvuk/schránku/zadávání/video a síťová spojení
- **[src/client.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/client.rs)**: spouští připojení k protějšku
- **[src/rendezvous_mediator.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/rendezvous_mediator.rs)**: komunikace s [OABRemoteDesk-server](https://github.com/OABRemoteDesk/OABRemoteDesk-server), očekávání vzdálených příméhých („proděrováváním“ TCP) nebo předávaných (relay) spojení
- **[src/platform](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/platform)**: zdrojové kódy, specifické pro jednotlivé platformy
- **[flutter](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/flutter)**: zdrojové kódy pro použití s aplikačním rámcem (framework) Flutter pro mobilní platformy
- **[flutter/web/js](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/flutter/web/js)**: Javascript pro Flutter webový klient
