<p align="center">
  ...
  <b>Vi har brug for din hjælp til at oversætte denne README, <a href="https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/lang">OABRemoteDesk UI</a> og <a href=" https://github.com/OABRemoteDesk/doc.OABRemoteDesk.com">Dokument</a> til dit modersmål</b>
</p>

Chat med os: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Endnu en fjernskrivebordssoftware, skrevet i Rust. Fungerer ud af æsken, ingen konfiguration påkrævet. Du har fuld kontrol over dine data uden bekymringer om sikkerhed. Du kan bruge vores rendezvous/relay-server, [opsætte din egen](https://OABRemoteDesk.com/server), eller [skrive din egen rendezvous/relay-server](https://github.com/OABRemoteDesk/OABRemoteDesk- server-demo).

OABRemoteDesk hilser bidrag fra alle velkommen. Se [`docs/CONTRIBUTING.md`](docs/CONTRIBUTING.md) for at få hjælp til at komme i gang.

[**PROGRAM DOWNLOAD**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
## [Byg](https://OABRemoteDesk.com/docs/en/dev/build/)
...
OABRemoteDesk understøtter ikke Wayland. Tjek [dette](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/) for at konfigurere Xorg som standard GNOME-session.

## Wayland-support

Wayland ser ikke ud til at levere nogen API til at sende tastetryk til andre vinduer. Derfor bruger OABRemoteDesk et API fra et lavere niveau, nemlig `/dev/uinput`-enheden (Linux-kerneniveau).
...
$ OABRemoteDesk
```
**Bemærk**: Wayland-skærmoptagelse bruger forskellige grænseflader. OABRemoteDesk understøtter i øjeblikket kun org.freedesktop.portal.ScreenCast.
```bash
...
Sørg for, at du kører disse kommandoer fra roden af OABRemoteDesk-lageret, ellers kan applikationen muligvis ikke finde de nødvendige ressourcer. Bemærk også, at andre cargo underkommandoer såsom 'install' eller 'run' i øjeblikket ikke understøttes via denne metode, da de ville installere eller køre programmet inde i containeren i stedet for værten.

## Filstruktur

- **[libs/hbb_common](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs funktioner til filoverførsel og nogle andre hjælpefunktioner
- **[libs/scrap](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/scrap)**: Skærmbillede
- **[libs/enigo](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/enigo)**: platform specifik tastatur/mus kontrol
- **[src/ui](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/server)**: lyd/udklipsholder/input/videotjenester og netværksforbindelser
- **[src/client.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/client.rs)**: starte en peer-forbindelse
- **[src/rendezvous_mediator.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/rendezvous_mediator.rs)**: Kommuniker med [OABRemoteDesk-server](https://github.com/OABRemoteDesk/OABRemoteDesk-server), vent på direkte fjernforbindelse (TCP-hulning) eller relæforbindelse
- **[src/platform](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/platform)**: Javascript til Flutter webklient
