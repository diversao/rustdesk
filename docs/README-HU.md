<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/lang">a OABRemoteDesk UI-t</a> és a <a href="https://github.com/OABRemoteDesk/doc.OABRemoteDesk.com">Dokumentációt</a> az anyanyelvedre</b>
</p>

Beszélgess velünk: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

A OABRemoteDesk egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a OABRemoteDesk punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://OABRemoteDesk.com/server), vagy akár [írhatsz is egyet](https://github.com/OABRemoteDesk/OABRemoteDesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A OABRemoteDesk szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a OABRemoteDesk?**](https://github.com/OABRemoteDesk/OABRemoteDesk/wiki/How-does-OABRemoteDesk-work%3F)

[**BINARY LELTÖLTÉS**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
## [Építés](https://OABRemoteDesk.com/docs/hu/dev/build/)
...
A OABRemoteDesk nem támogatja a Waylendet. [Itt](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/) található egy tutorial amelynek segítségével beállíthatod a Xorg-ot mint alap GNOME session.
...
Ezután, minden egyes alkalommal amikor meg kell építened a OABRemoteDesk-et, futtasd a kövezkező parancsot:
...
Kérlek mindenképpen nézd meg hogy ezeket a parancsokat a root OABRemoteDesk mappában futtatod e, különben a OABRemoteDesk lehet hogy nem fogja megtalálni az építéshez szükséges elemeket. Fontos az is, hogy jelenleg más cargo subparancsok, például `install`vagy `run` nem támogatottak, mivel egy Dockeres építés esetén elindítanák a programot a containeren belül.
