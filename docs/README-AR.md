<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/OABRemoteDesk/doc.OABRemoteDesk.com">Doc</a> و <a href="https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/lang">OABRemoteDesk UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>

[Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk) :تواصل معنا عبر
...
[جهز لنفسك واحدا](https://OABRemoteDesk.com/server), أو
[خاص بك rendezvous/relay أكتب خادم](https://github.com/OABRemoteDesk/OABRemoteDesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  OABRemoteDesk.

[**؟ OABRemoteDesk كيفية يعمل**](https://github.com/OABRemoteDesk/OABRemoteDesk/wiki/How-does-OABRemoteDesk-work%3F)

[**BINARY تنزيل**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
## [البناء](https://OABRemoteDesk.com/docs/en/dev/build/)
...
افتراضية GNOME session  ك Xorg إتبع [هذه](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/) الخطوات لإعداد Wayland لا تدعم OABRemoteDesk
...
OABRemoteDesk يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
...
- **[libs/hbb_common](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/hbb_common)**: وظائف  لنقل الملفات، وبعض وظائف المرافق الأخرى tcp/udp، protobuf ترميز الفيديو، إعدادات

- **[libs/scrap](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/scrap)**: التقاط الشاشة
- **[libs/enigo](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/enigo)**: التحكم في لوحة المفاتيح/الماوس الخاصة بكل منصة
- **[src/ui](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/ui)**: واجهة المستخدم الرسومية
- **[src/server](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/server)**: خدمات الصوت/الحافظة/المدخلات/الفيديو، ووصلات الشبكة
- **[src/client.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/client.rs)**: بدء اتصال متقارن
- **[src/rendezvous_mediator.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/rendezvous_mediator.rs)**: أو المنقول عن بُعد (TCP hole punching) انتظر الاتصال المباشر [OABRemoteDesk-server](https://github.com/OABRemoteDesk/OABRemoteDesk-server) الإتصال ب
- **[src/platform](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/platform)**: رمز خاص بكل منصة
- **[flutter](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/flutter)**: رمز الهاتف المحمول
- **[flutter/web/js](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/flutter/web/js)**:Flutter  لعميل الويب الخاص ب Javascript
