<p align="center">
  <img src="../res/logo-header.svg" alt="OABRemoteDesk - il tuo desktop remoto"><br>
  ...
  <b>Abbiamo bisogno del tuo aiuto per tradurre questo file README e la <a href="https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/lang">UI OABRemoteDesk</a> nella tua lingua nativa</b>
</p>

Chatta con noi su: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/OABRemoteDesk) | [Reddit](https://www.reddit.com/r/OABRemoteDesk)
...
Puoi usare il nostro server rendezvous/relay, [configurare il tuo server](https://OABRemoteDesk.com/server) o [realizzare il tuo server rendezvous/relay](https://github.com/OABRemoteDesk/OABRemoteDesk-server-demo).

OABRemoteDesk accoglie il contributo di tutti. 
Per ulteriori informazioni su come iniziare a contribuire, vedi [`docs/CONTRIBUTING-IT.md`](CONTRIBUTING.md).

[**DOWNLOAD PROGRAMMA**](https://github.com/OABRemoteDesk/OABRemoteDesk/releases)
...
OABRemoteDesk non supporta Wayland. 
...
Assicurati di eseguire questi comandi dalla radice del repository OABRemoteDesk, altrimenti l'applicazione potrebbe non essere in grado di trovare le risorse richieste. 
...
- **[libs/hbb_common](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/hbb_common)**: codec video, config, wrapper tcp/udp, protobuf, funzioni per il trasferimento file, e altre funzioni utili.
- **[libs/scrap](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/scrap)**: cattura dello schermo
- **[libs/enigo](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/libs/enigo)**: controllo tastiera/mouse specifico della piattaforma
- **[src/ui](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/server)**: servizi audio/appunti/input/video e connessioni di rete
- **[src/client.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/client.rs)**: avvio di una connessione peer
- **[src/rendezvous_mediator.rs](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/rendezvous_mediator.rs)**: Comunica con [OABRemoteDesk-server](https://github.com/OABRemoteDesk/OABRemoteDesk-server), attende la connessione remota diretta (TCP hole punching) oppure indiretta (relayed)
- **[src/platform](https://github.com/OABRemoteDesk/OABRemoteDesk/tree/master/src/platform)**: codice specifico della piattaforma
