...
!define PRODUCT_NAME "OABRemoteDesk"
...
Name "${PRODUCT_NAME}"
Outfile "OABRemoteDesk-${VERSION}-setup.exe"
...
Section "Install"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "HelpLink" "https://www.OABRemoteDesk.com/"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "URLInfoAbout" "https://www.OABRemoteDesk.com/"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "URLUpdateInfo" "https://www.OABRemoteDesk.com/"
