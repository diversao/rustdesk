...
def write_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("OABRemoteDesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../OABRemoteDesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\OABRemoteDesk\flutter\build\windows\runner\Debug\ -o . -e ..\OABRemoteDesk\flutter\build\windows\runner\Debug\OABRemoteDesk.exe
