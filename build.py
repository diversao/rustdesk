...
def build_flutter_windows(version, features):
    ...
    system2(
        f'python3 ./generate.py -f ../../{flutter_build_dir_2} -o . -e ../../{flutter_build_dir_2}/OABRemoteDesk')
    os.chdir('../..')
...
def main():
    ...
    if windows:
        ...
        # system2('upx.exe target/release/OABRemoteDesk')
        system2('mv target/release/OABRemoteDesk target/release/OABRemoteDesk')
        pa = os.environ.get('P')
        if pa:
            system2(
            ...
            print('Not signed')
        system2(
            f'cp -rf target/release/OABRemoteDesk {res_dir}')
        os.chdir('libs/portable')
        system2('pip3 install -r requirements.txt')
        system2(
